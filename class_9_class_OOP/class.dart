...
Create factory constructor for car and bike which create instance of vehicle with proper type "car" and "bike" respectively with proper noWheels.
*/

class Vehicle {
  // type, noWheels, mileage, totalDistanceTravelled, currentPterol,
